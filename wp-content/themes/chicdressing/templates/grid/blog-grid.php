...
<div class="main-container">
	...
	echo '<h2 id="leblog" class="chic-title">Dernières pièces de créateur </h2>';
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="http://localhost/chic_dressing_init/#leblog">Voir tous les articles</a></p>';
